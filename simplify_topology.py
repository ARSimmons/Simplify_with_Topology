                ...
                for myGeom in input:
                    ...
                    if isinstance(myShape, LineString):
                        ...
                        if Topology:
                            ...
                            simplifiedShapes = [simplify.simplify_polygon(polygon, threshold)]
                        ...
                        if Topology:
                            ...
                            simplifiedShapes = [simplify.simplify_multipolygon (mpolygon, threshold)]
...
def main():
    ...
    if topology is False:
        geomSimplifyObject.process_file(inputFile, outputFile, float(threshold), topology)
